...
import { Music, Plus, LogOut, Trash2, Edit } from "lucide-react";
      ...
      <header className="border-b bg-card">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-bold">Good Tree Music Admin</h1>
              <p className="text-sm text-muted-foreground">Song Management</p>
            </div>
          </div>
            ...
            <CardHeader>
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <CardDescription>Manage all worship songs and their details</CardDescription>
                </div>
